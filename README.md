...
semantic tags give meaning and context to html
...
it allows multiple developers to colaborate on a single project and keeps track of previous changes and edits without adding extra files and clutter

5. Define mobile-first design in your own words.

rather than scale your design down like you would for desktop mobile-first design scales up from a mobile size
